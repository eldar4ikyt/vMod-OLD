...
public class HUDConfigScreen extends GuiScreen {
    ...
    @Override
    public boolean drawScreen(int mouseX, int mouseY, float partialTicks) {
    ...
    @Override
    protected void drawHallowRect(int absoluteX, int absoluteY, int width, int height, int i) {
